    ...
    <div class="container" data-aos="fade-up">
      <div class="row">
        ...
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
          ...
          <ul>
            <li>
              <i class="bi bi-check-circle" /> Ullamco laboris nisi ut aliquip ex
              ea commodo consequat.
            </li>
            <li>
              <i class="bi bi-check-circle" /> Duis aute irure dolor in reprehenderit
              in voluptate velit.
            </li>
            <li>
              <i class="bi bi-check-circle" /> Ullamco laboris nisi ut aliquip ex
            ...
            <div class="course-content">
              ...
              >
                ...
                <div class="trainer-rank d-flex align-items-center">
                  <i class="bx bx-user" />&nbsp;50 &nbsp;&nbsp;
                  <i class="bx bx-heart" />&nbsp;65
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="course-item">
            ...
            <div class="course-content">
              ...
              >
                ...
                <div class="trainer-rank d-flex align-items-center">
                  <i class="bx bx-user" />&nbsp;35 &nbsp;&nbsp;
                  <i class="bx bx-heart" />&nbsp;42
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="course-item">
            ...
            <div class="course-content">
              ...
              >
                ...
                <div class="trainer-rank d-flex align-items-center">
                  <i class="bx bx-user" />&nbsp;20 &nbsp;&nbsp;
                  <i class="bx bx-heart" />&nbsp;85
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-6 footer-links">
          ...
          <ul>
            ...
            <li>
              <i class="bx bx-chevron-right" /> <a href="#!">Terms of service</a>
            </li>
            <li>
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          ...
          <ul>
            ...
            <li>
              <i class="bx bx-chevron-right" /> <a href="#!">Web Development</a>
            </li>
            <li>
